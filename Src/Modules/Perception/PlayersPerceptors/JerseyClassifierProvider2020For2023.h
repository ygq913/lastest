...
{,
  ...
  LOADS_PARAMETERS( // [FIX] Changed from DEFINES_PARAMETERS to LOADS_PARAMETERS to support runtime config file loading
  {,
    ...
    (float)(1.0f) scanWidthRatio, /**< [FIX] Horizontal scan width as ratio of obstacle bbox width (1.0=full, 0.7=70%). Lower to exclude arms. */
    ...
    (unsigned char)(45) minColoredSaturation, /**< [FIX] Below this saturation, hue is noise — skip hue check in black classifier. */
  }),
});
