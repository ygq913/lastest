...
public:
  ...
  /**
   * Sets the ball velocity in the coordinate system of the robot's team.
   * @param velocity The velocity to set (x, y, z in mm/s).
   */
  void setBallVelocity(const Vector3f& velocity);

  /**
   * Kicks the ball to a target position within the coordinate system of the robot's team.
   * @param target The target position on the field (x, y in mm).
   * @param speed The speed of the kick (in mm/s).
   */
